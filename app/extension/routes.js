...
function setupRoutes(ext) {
    ...
    extensionRoutes.get("/fp/install", async (req, res, next) => {
    ...
    extensionRoutes.get("/fp/auth", sessionMiddleware(false), async (req, res, next) => {
    ...
    extensionRoutes.post("/fp/auto_install", sessionMiddleware(false), async (req, res, next) => {
        try {
    ...
    extensionRoutes.post("/fp/uninstall", async (req, res, next) => {
        try {
